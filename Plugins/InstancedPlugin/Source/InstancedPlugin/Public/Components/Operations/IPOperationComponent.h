...
UCLASS(Blueprintable, Meta = (BlueprintSpawnableComponent), AutoExpandCategories = ("Operation | Execution", "Operation | Parameters"), AutoCollapseCategories = (Transform), HideCategories = (Transform))
