...
public:
	...
	/** Min random location */
	UPROPERTY(EditAnywhere, Category = "Procedure | Parameters", Meta = (EditCondition = "bRandomLocation"))
	...
	/** Min random rotation */
	UPROPERTY(EditAnywhere, Category = "Procedure | Parameters", Meta = (EditCondition = "bRandomRotation"))
	...
	/** Fixed rotator */
	UPROPERTY(EditAnywhere, Category = "Procedure | Parameters", Meta = (EditCondition = "bRandomRotationByFixedRotatorStepsEditCondition"))
	...
	UPROPERTY(EditAnywhere, Category = "Procedure | Parameters", Meta = (EditCondition = "bRandomScale"))
